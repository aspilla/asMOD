...
- **Health Bar:** * Displays current health, max health, and percentage (%). * Displays death status. * Displays incoming healing and shields (absorption). * Displays class colors
- **Resource Bar:**
