...
if version == 100200 then
	ACI_Options_Default = {
		...
		ACI_SpellList_ROGUE_1 = {
			{ 99, "혈폭풍", { "혈폭풍", 4, nil, 12 * 0.3 }, { "독살", 2, nil, 1, nil, nil, nil, "증폭의 독" } },
			{ "독칼", 4 },
			{ "죽음표식", 4 },
			{ "목조르기", 4, nil, 1 },
			{ "파열", 4, nil, 24 * 0.3 },
		...
		ACI_SpellList_HUNTER_1 = {
			{ 99, "야수의 회전베기", { 118455, 7, "pet", 2 }, { "광포한 야수", 1 } },
			{ "살상 명령", 1 },
			{ "야수의 격노", 2 },
			{ "마무리 사격", 1 },
		...
		ACI_SpellList_HUNTER_2 = {
			...
			{ "속사", 1 },
			{ "정조준", 2, nil, nil, nil, nil,"윈드러너의 인도" },
			{ "마무리 사격", 1 },
		...
		ACI_SpellList_HUNTER_3 = {
			...
			{99, "협공", { "협공", 2 }, { "측방 강타", 1 }},
			{ "마무리 사격", 1 },
			{ 99, "독수리의 분노", { "독수리의 분노", 2, "player", nil, nil, "격노의 일격" },
				{ "죽음의 회전 표창", 4 } },
		},
		...
		ACI_SpellList_MAGE_1 = {
			...
			{ "비전 보주", 1 },
			{ "비전 쇄도", 2 },
			{ 99, "빛나는 불꽃", { "빛나는 불꽃", 4, "target", 0, 3, "빛나는 불꽃 약화" },
				{ 332769, 7, "player", nil, 15 } },
			{ "황천의 폭풍우", 4 },
		},

		--화염
		ACI_SpellList_MAGE_2 = {
			{ 383883, 7, nil, 30, nil, nil, "태양왕의 축복" },
			{ "불태우기", 9, 30, nil, "불태우기 연마" },
			{ "발화", 2 },
			{ "용의 숨결", 1 },
			{ 99, "이상 고열", { 383860, 7 }, { "유성", 1 } },
		},
		...
		ACI_SpellList_DEATHKNIGHT_2 = {
			{ "죽음과 부패", 2, nil, nil, nil, "죽음과 부패" },
			{ 99, "몰아치는 한기", { "몰아치는 한기", 2, nil, nil, nil, "싸늘한 분노" }, { 377195, 7, "player" } },
			{ "얼음 기둥", 2 },
			{ "냉혹한 겨울", 2 },
			{ "울부짖는 한파", 4, nil, 0, nil, "서리 열병" },
		...
		ACI_SpellList_DEATHKNIGHT_3 = {
			...
			{ "고름 일격", 4, nil, 0, 6, "고름 상처" },
		},

		--양조
		ACI_SpellList_MONK_1 = {
			{ 99, "비취 돌풍", { "비취 돌풍", 2 }, { 322120, 7, "player" } },
			{ "해오름차기", 1 },
			{ "맥주통 휘두르기", 1 },
			{ "후려차기", 1 },
			{ "해악 축출", 1 },
		...
		ACI_SpellList_MONK_2 = {
			{ 99, "셰이룬의 선물", { "셰이룬의 선물", 1}, { "후려차기", 1, nil, "수도원의 가르침" }},
			{ 99, "셰이룬의 선물", { "해오름차기", 1, nil, "수도원의 가르침" }, { "해오름차기", 1}},
			{ 99, "주학 츠지의 원령", { "주학 츠지의 원령", 11, "츠지", nil, "주학 츠지의 원령" },
				{ "옥룡 위론의 원령",
					11, "위론" } },
		...
		ACI_SpellList_MONK_3 = {
			...
			{ 99, "폭풍과 대지와 불", { "폭풍과 대지와 불", 2, nil, nil, nil, "폭풍과 대지와 불" },
				{ "평안", 2 } },
			{ "백호 쉬엔의 원령", 11, "쉬엔", nil, "쉬엔의 분노" },
			{ "분노의 주먹", 1, nil, "힘 전달" },
			{ "해오름차기", 1, nil, "수도원의 가르침" },
		...
		ACI_SpellList_DRUID_1 = {
			...
			{ "천체의 정렬", 2, nil, nil, nil, nil, "태고의 비전 맥동" },
		...
		ACI_SpellList_SHAMAN_1 = {
			{ 99, "폭풍수호자", { "폭풍수호자", 2 }, { 16166, 7, "player" } },
			{ "용암 폭발", 1 },
			{ 99, "폭풍의 정령", { "폭풍의 정령", 11, "상급 폭풍의 정령" }, { "불의 정령", 11,
				"상급 불의 정령" } },
		...
		ACI_SpellList_SHAMAN_2 = {
			...
			{ "용암 채찍", 1, nil, "잿빛 수정" },
			{ "야수 정령", 2 },
			{ 99, "우박폭풍", { "냉기 충격", 1, nil, "우박폭풍" }, { "용암 폭발", 1 } },
			{ 99, "태고의 파도", { "태고의 파도", 2 }, { "화염 충격", 4, nil, 1 } },
		},
		...
		ACI_SpellList_WARLOCK_1 = {
			...
			{ 99, "생명력 착취", { "생명력 착취", 4, nil, 1 }, { "암흑시선 소환", 11, "암흑시선" } },
			{ "유령 출몰", 4 },
			{ "불안정한 고통", 4, nil, 1 },
			{ "부패", 4, nil, 1 },
			{ "고통", 4, nil, 1 },
		...
		ACI_SpellList_WARLOCK_2 = {
			...
			{ "마력 착취", 1 },
			{ 99, "흑마법서: 지옥수호병", { "흑마법서: 지옥수호병", 11, "지옥수호병" }, { "지옥폭풍",
				1 } },
	...
	ACI_Options_Default = {
		...
		ACI_SpellList_HUNTER_3 = {
			...
			{ "협공", 2 },
			{ "마무리 사격", 1 },
			{ 99, "독수리의 분노", { "독수리의 분노", 1 }, { "죽음의 회전 표창", 4 } },
		},
		...
		ACI_SpellList_PRIEST_1 = {
			{ "어둠의 권능: 죽음", 1 },
			{ 99, "어둠의 서약", { "어둠의 서약", 2 }, { "신의 권능: 보호막", 1 } },
			{ "환희", 2 },
			{ "회개", 1, nil, "엄격한 규율" },
			{ "어둠의 권능: 고통", 4, nil, 1 },
		...
		ACI_SpellList_WARLOCK_2 = {
			...
			{ 99, "흑마법서: 지옥수호병", { "흑마법서: 지옥수호병", 11, "지옥수호병" }, { "지옥폭풍",
				1 } },
			{ "악마 폭군 소환", 2, "player", nil, nil, "악마의 힘" },
			{ 99, "파열", { "파열", 1 }, { "악마의 기운", 2, "pet" } },
			{ "공포사냥개 부르기", 4, nil, 0, nil, "사냥개조련사의 책략" },
		},
