...
if version == 100200 then
	ACI_Options_Default = {
		...
		ACI_SpellList_ROGUE_1 = {
			{ 99, "혈폭풍", { "혈폭풍", 4, nil, 12 * 0.3 }, { "독살", 2, nil, 1 } },
			{ "독칼", 4 },
			{ "죽음표식", 4 },
			{ "목조르기", 4, nil, 1 },
			{ "파열", 4, nil, 24 * 0.3 },
		...
		ACI_SpellList_HUNTER_3 = {
			...
			{ "협공", 2 },
			{ "마무리 사격", 1 },
			{ 99, "독수리의 분노", { "독수리의 분노", 2, "player", nil, nil, nil, "격노의 일격" },
				{ "죽음의 회전 표창", 4 } },
		},
		...
		ACI_SpellList_PRIEST_1 = {
			{ "어둠의 권능: 죽음", 1 },
			{ "어둠의 마귀", 2, nil, nil, nil, nil, "어둠의 서약" },
			{ "환희", 2 },
			{ "회개", 1 },
			{ "어둠의 권능: 고통", 4, nil, 1 },
		},
		...
		ACI_SpellList_DEATHKNIGHT_2 = {
			{ "죽음과 부패", 2, nil, nil, nil, nil, "죽음과 부패" },
			{ 99, "몰아치는 한기", { "몰아치는 한기", 1 }, { 377195, 7, "player" } },
			{ "얼음 기둥", 2 },
			{ "냉혹한 겨울", 2 },
		...
		ACI_SpellList_MONK_2 = {
			{ 388812, 7, "player" },
			{ "해오름차기", 1 },
			{ 99, "주학 츠지의 원령", { "주학 츠지의 원령", 11, "츠지" }, { "옥룡 위론의 원령",
				11, "위론" } },
			{ "집중의 천둥 차", 2 },
			{ "정수의 샘", 1 },
		},
		...
		ACI_SpellList_MONK_3 = {
			...
			{ 99, "폭풍과 대지와 불", { "폭풍과 대지와 불", 2, nil, nil, nil, nil, "폭풍과 대지와 불" },
				{ "평안", 2 } },
			{ "백호 쉬엔의 원령", 11, "쉬엔" },
			{ "분노의 주먹", 1 },
			{ "해오름차기", 1 },
		...
		ACI_SpellList_DRUID_2 = {
			{ "난타", 4 },
			{ 99, "최상위 포식자의 갈망", { 339139, 7, "player", 20 }, { "광폭화", 2 } },
			{ "호랑이의 분노", 2 },
			{ "도려내기", 4, nil, 19 * 0.3 },
			{ "갈퀴 발톱", 4, nil, 12 * 0.3 },
		},
		...
		ACI_SpellList_WARLOCK_2 = {
			...
			{ 99, "흑마법서: 지옥수호병", { "흑마법서: 지옥수호병", 11, "지옥수호병" }, { "지옥폭풍",
				1 } },								
			{ "악마 폭군 소환", 2, "pet", nil, nil, nil, "악마의 힘" },
	...
	ACI_Options_Default = {
		...
		-- 암살
		ACI_SpellList_ROGUE_1 = {
			{ 99, "혈폭풍", { "혈폭풍", 4, nil, 12 * 0.3 }, { 193641, 7, "player", 2 } },
			{ "독칼", 4 },
			{ "죽음표식", 4 },
			{ "목조르기", 4, nil, 1 },
			{ "파열", 4, nil, 24 * 0.3 },
