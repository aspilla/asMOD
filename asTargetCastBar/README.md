...
* **Target of Target**: Shows the name of the player being targeted by the spell, displayed in their respective class color.
* **Raid Markers**: Displays the raid marker of the casting unit.
* **Interruptibility Color Coding**:
    * The cast bar color changes based on whether the spell can be interrupted and whether it is targeting you.
