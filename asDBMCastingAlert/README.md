...
- Hides casting bars for your focus target (Default: On).
- Hides casting bars for your current target (Default: On).
- The maximum number of casting bars to display (Default: 3, range 1–10).
