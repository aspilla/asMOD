...
*   **전투 부활 주문 추적**: 전투 부활 주문의 아이콘, 현재 사용 가능한 충전 횟수, 그리고 재사용 대기 중일 경우 남은 시간을 표시
*   **상황별 자동 표시/숨김**:
    *   파티 또는 공격대에 속해 있을 경우 항상 표시
    *   그룹에 속해 있지 않더라도, 프레임 잠금이 해제되어 있으면 위치 조정을 위해 표시
    *   그룹에 속해 있지 않고 프레임이 잠겨 있으면 자동으로 숨겨짐
