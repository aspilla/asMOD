...
ns.ANameP_AlertList = {
    ...
    [179733] = { 1, 1, 0.2, 1 }, -- 노란색 빤짝이 TWW S3 꼬챙이 (승부수)
    [180433] = { 1, 1, 0.2, 1 }, -- 노란색 빤짝이 TWW S3 떠도는-전파-천체 (승부수)
    [240952] = { 1, 1, 0.2, 1 }, -- 노란색 빤짝이 TWW S3 Evoked Spirit (Eco-Doom)
...
local function panelOnShow()
    ...
    if GetLocale() == "koKR" then
        ...
        SetupCheckBoxOption("[기력] 하단에 기력 표시", "ANameP_ShowPower"); -- Show Power
