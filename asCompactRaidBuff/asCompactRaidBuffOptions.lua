...
local L = {
	...
	ShowRemain = "[Left] Display the remain time of HOT buff",
	ShowPandemicColor = "[Color] Change health color when HOT pandemic time",
	RemainFontSize = "[Size] Remain font size",
}
...
if GetLocale() == "koKR" then
	L = {
		...
		ShowRemain = "[좌측] 힐러 HOT 버프시 남은 시간을 표시",
		ShowPandemicColor = "[색상] 힐러 HOT 버프 Pandemic 시간에 색상 변경",
		RemainFontSize = "[크기] 남은 시간 글씨 크기",
	}
end
