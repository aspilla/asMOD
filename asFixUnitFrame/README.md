...
![asFixUnitFrame](https://media.forgecdn.net/attachments/1585/691/asfixunitframe-png.png)
...
- Hide debuffs on the Target (Default: Enabled).
- Hide combat text on the Player frame (Default: Enabled).
- Hide the Target's cast bar (Default: Enabled).
- Hide the Player's class bar (Default: Enabled).
- Hide the Player's totem bar (Default: Disabled).
- Change health bar colors to class colors (Default: Enabled).
- Display numeric threat level on the Target (Default: Enabled).
