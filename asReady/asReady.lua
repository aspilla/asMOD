...
local AREADY_X = -453;        -- X 위치
local AREADY_Y = 138;         -- Y 위치
...
local tempbar = CreateFrame("StatusBar")
tempbar:SetMinMaxValues(0, 9999999)
local updated_value = nil
tempbar:SetScript("OnValueChanged", function(self, value)
    updated_value = value
end)
...
local function AREADY_OnEvent(self, event, arg1, arg2, arg3)
    if event == "UNIT_SPELLCAST_SUCCEEDED" then
        if (arg1 == "player" or arg1 == "pet" or string.find(arg1, "party") or string.find(arg1, "raid")) then
            if issecretvalue(arg3) then
                updated_value = nil
                tempbar:SetValue(0)
                pcall(tempbar.SetValue, tempbar, arg3)
                local spellid = updated_value
                OnSpellEvent(arg1, spellid);
            else
