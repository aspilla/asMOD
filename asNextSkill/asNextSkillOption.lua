...
local L = {
	ShowHotKey = "Show Hotkey",
	AssistShowOnly = "Suggest Skills on Action Bars Only",
	UIScale = "UI Scale",
	MillisecondsThreshold = "Cooldown Display Threshold (0.1s)",
}

if GetLocale() == "koKR" then
	L = {
		ShowHotKey = "단축키 표시",
		AssistShowOnly = "단축바에 등록된 기술만 안내",
		UIScale = "UI 크기",
		MillisecondsThreshold = "0.1초 단위 쿨다운 표시 시간",
	}
end
