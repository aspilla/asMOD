...
3. `Combat` > `Spell Alert Opacity` 65%, `Personal Resource Display` Off, `Scroll My Combat Text` Off
4. `Nameplates` > `NPC Names` All NPCs, `Always Show Nameplates` On, `Enemy Units` On, `Friendly Players` On, `Nameplate Motion Type` Stacking Nameplates, `Friendly NPC Nameplates` Off, `Style` Larger Nameplates (Block Bar), `[Friendly Nameplates] Show Name Only` On, `[Friendly Nameplates] Use Class Color for Name` On, `[Friendly Nameplates] Server Name` Off
...
| asCooldownPulse       | Ready Spell Alert, Defensive spell/healthstone/potion cooldowns |    [Link](https://www.curseforge.com/wow/addons/ascooldownpulse)    |    [Link](https://github.com/aspilla/asMOD/tree/main/asCooldownPulse)    |
| asCountdown           | Countdown Voice Alerts                                          |      [Link](https://www.curseforge.com/wow/addons/ascountdown)      |      [Link](https://github.com/aspilla/asMOD/tree/main/asCountdown)      |
...
| asFirestarter         | (Optional) Firestarter and Scorch Alerts                        |     [Link](https://www.curseforge.com/wow/addons/asfirestarter)     |     [Link](https://github.com/aspilla/asMOD/tree/main/asFirestarter)     |
...
2. **English Users**: Visit the [asMOD Page](https://www.curseforge.com/wow/addons/asmod) or [GitHub](https://github.com/aspilla/asMOD/)
...
- **Position Configuration**: Refer to the [## Positioning Guide](##-Positioning-Guide) to adjust the layout.
...
- [asNamePlates](https://www.curseforge.com/wow/addons/asnameplates)

### 12. Click Casting / Mouse Wheel Casting
...
```
2005년 남이 만든 애드온을 사용하다가 게임 끊김 현상을 느껴, 제가 쓸 애드온은 직접 만들어 사용하기 시작했습니다.
애드온을 일일이 설정하는 것 역시 귀찮은 일이었기에 별도의 설정조차 없는 간단한 애드온들이었습니다.
2008년부터는 직접 만든 애드온을 인벤에 공유해 왔고, 2025년부터는 커스포지를 통해 공유하고 있습니다.
20여 년간 만들어 온 애드온이 어느덧 40여 개에 달하며, 나름대로 다음과 같은 방침을 지속해서 지켜오고 있습니다.

1) 애드온 기능 간결하고 게임 성능에 영향이 없어야 한다.
2) 복잡한 설정 과정이 없어야 한다.
...
3. `전투` > `주문 경보 투명도` 65%, `개인 자원 표시` Off, `자신의 전투 상황 알림 스크롤` Off
4. `이름표` > `NPC 이름 표시` 모든 NPC, `항상 이름표 표시` On, `적 개채 이름표` On, `아군 플레이어 이름표` On, `이름표 상하 정렬` 적대적 대상, `아군 NPC 이름표` Off, `양식` 블록 막대, `[아군 이름표] 이름만 표시` On, `[아군 이름표] 이름 직업 색상 사용` On, `[아군 이름표] 서버 이름` Off
...
| asCooldownPulse       | 준비된 스킬 알림, 생존기/생석/물약 쿨    |    [링크](https://www.curseforge.com/wow/addons/ascooldownpulse)    |    [링크](https://github.com/aspilla/asMOD/tree/main/asCooldownPulse)    |
| asCountdown           | 초읽기 음성 알림                         |      [링크](https://www.curseforge.com/wow/addons/ascountdown)      |      [링크](https://github.com/aspilla/asMOD/tree/main/asCountdown)      |
...
| asDBMCastingAlert     | 시전중인 몹의 케스팅바를 표시            |   [링크](https://www.curseforge.com/wow/addons/asdbmcastingalert)   |   [링크](https://github.com/aspilla/asMOD/tree/main/asDBMCastingAlert)   |
...
| asFirestarter         | (미포함) 방화광 및 불태우기 알림         |     [링크](https://www.curseforge.com/wow/addons/asfirestarter)     |     [링크](https://github.com/aspilla/asMOD/tree/main/asFirestarter)     |
...
2. `영문 유저` : `asMOD Page` 방문 (https://www.curseforge.com/wow/addons/asmod), `Github` 방문 (https://github.com/aspilla/asMOD/)

#### 설명서

위 설명서를 꼭 다 읽고 질문해 주세요.
모든 설명서는 영문 > 한글 순으로 작성 되어 있습니다.
...
- **위치 설정:** [## 위치 설정 방법](##-위치-설정-방법) 을 참고하여 조정하세요.
